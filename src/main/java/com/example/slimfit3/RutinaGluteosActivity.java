...
public class RutinaGluteosActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rutina_gluteos);
        ...
        //Empieza Rutina
        imgRutina.setImageResource(R.drawable.routine21);
                                                                                                                                                                    ...
                                                                                                                                                                    public void onFinish() {
                                                                                                                                                                        ...
                                                                                                                                                                        new CountDownTimer(4000,1000) {
                                                                                                                                                                            ...
                                                                                                                                                                            public void onFinish() {
                                                                                                                                                                                ...
                                                                                                                                                                                Intent intent = new Intent(RutinaGluteosActivity.this, EjerciciosActivity.class);
                                                                                                                                                                                startActivity(intent);

                                                                                                                                                                                Toast.makeText(RutinaGluteosActivity.this, "Felicidades, lograste el entrenamiento", Toast.LENGTH_LONG).show();
