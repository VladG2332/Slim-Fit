...
public class RutinaPiernaActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rutina_pierna);
        ...
        TextView viewContador = findViewById(R.id.viewContador4);
        TextView viewEncabezado = findViewById(R.id.viewEncabezado4);
        final MediaPlayer mp = MediaPlayer.create(this,R.raw.whistle);
        final MediaPlayer mp1 = MediaPlayer.create(this,R.raw.bell);
        GifImageView imgRutina = findViewById(R.id.imgRutina4);
        Button btnTerminado = findViewById(R.id.btnTerminado4);
                                                                                                                                                                    ...
                                                                                                                                                                    public void onFinish() {
                                                                                                                                                                        ...
                                                                                                                                                                        new CountDownTimer(4000,1000) {
                                                                                                                                                                            ...
                                                                                                                                                                            public void onFinish() {
                                                                                                                                                                                ...
                                                                                                                                                                                Intent intent = new Intent(RutinaPiernaActivity.this, EjerciciosActivity.class);
                                                                                                                                                                                startActivity(intent);

                                                                                                                                                                                Toast.makeText(RutinaPiernaActivity.this, "Felicidades, lograste el entrenamiento", Toast.LENGTH_LONG).show();
