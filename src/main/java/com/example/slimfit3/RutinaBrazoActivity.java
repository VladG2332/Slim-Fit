...
public class RutinaBrazoActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rutina_brazo);
        ...
        TextView viewContador = findViewById(R.id.viewContador3);
        TextView viewEncabezado = findViewById(R.id.viewEncabezado3);
        final MediaPlayer mp = MediaPlayer.create(this,R.raw.whistle);
        final MediaPlayer mp1 = MediaPlayer.create(this,R.raw.bell);
        GifImageView imgRutina = findViewById(R.id.imgRutina3);
        Button btnTerminado = findViewById(R.id.btnTerminado3);

        btnTerminado.setVisibility(View.INVISIBLE);

        //Empieza Rutina
        imgRutina.setImageResource(R.drawable.routine13);
                                                                                                                                                                    ...
                                                                                                                                                                    public void onFinish() {
                                                                                                                                                                        ...
                                                                                                                                                                        new CountDownTimer(4000,1000) {
                                                                                                                                                                            ...
                                                                                                                                                                            public void onFinish() {
                                                                                                                                                                                ...
                                                                                                                                                                                Intent intent = new Intent(RutinaBrazoActivity.this, EjerciciosActivity.class);
                                                                                                                                                                                startActivity(intent);

                                                                                                                                                                                Toast.makeText(RutinaBrazoActivity.this, "Felicidades, lograste el entrenamiento", Toast.LENGTH_LONG).show();
